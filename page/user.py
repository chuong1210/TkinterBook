...
# Tạo mặt nạ hình tròn để hình ảnh
        ...
        avatar_label.bind("<Button-1>", lambda e: self.home_page()) 
        ...
        settings_button = Button(sidebar_frame, textvariable=self.settings_button_text, command=lambda: self.settings_menu_show_hide(settings_menu, settings_button),bg='#108690',height=2)
        settings_button.pack(side='top', fill='x', pady=10)
 
        book_management_button = Button(sidebar_frame, text="Quản lý sách", command=self.manage_books,bg='#108690',height=2)
...
# tạo header frame
        ...
        header_frame.place(rely=0, relx=0.09, relwidth=0.9, relheight=0.12)
    ...
    def home_page(self):
        ...
        Label(self.main_frame, text="Đây là trang chính cho user", font=("Helvetica", 40)).pack(expand=True)
