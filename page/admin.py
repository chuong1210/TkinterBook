...
# tạo header frame
	...
	def manage_options(self):
		self.clear_main_content()
		user_icon = PhotoImage(file='path_to_icon1')
		Button(self.main_frame, text='Quản lý người dùng', command=self.manage_users, image=user_icon,
			compound=LEFT, width=200, height=50, bg='blue').pack(padx=10, pady=10)
		books_icon = PhotoImage(file='path_to_icon2')
		Button(self.main_frame, text='Quản lý sách', command=self.manage_books, image=books_icon,
			compound=LEFT, width=200, height=50, bg='red').pack(padx=10, pady=10)
		publishers_icon = PhotoImage(file='path_to_icon3')
		Button(self.main_frame, text='Quản lý nhà xuất bản', command=self.manage_publishers, image=publishers_icon,
			compound=LEFT, width=200, height=50, bg='green').pack(padx=10, pady=10)
